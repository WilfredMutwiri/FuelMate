...
export default function Alert() {
  ...
  const handleFuelRequest = async (req, res) => {
    ...
    if (
      ...
      ToastComponent(
        "error",
        "Please fill all fields before submitting the order."
      );
      setLoading(false);
      return;
    }
    ...
    try {
      if (
        ...
        !formData.clientLocation.coordinates ||
        formData.clientLocation.coordinates.length !== 2
      ) {
      ...
      const response = await axios.post(
        `${SERVER_URI}/api/v1/order/emergency/create/${user.id}`,
        {
          ...formData,
        }
      );
  ...
  useEffect(() => {
    const getAdminInfo = async () => {
      try {
        ...
        if (data.success) {
          let rawPhone = data.adminsInfo.phoneNo.toString();
          ...
          <View style={styles.emergencyCont}>
            <View>
              <Text style={styles.IntroTxt}>
                Out of fuel? Help is on the way. Request emergency fuel and our
                nearest station will deliver it right to you.
              </Text>
            </View>
            {/* form section */}
            <View style={styles.formContainer}>
              ...
              >
                <Text style={styles.btnTxt}>
                  Send offline message to support
                </Text>
              </TouchableOpacity>
            </View>
                ...
                <View style={styles.modalOverlay}>
                  <View>
                    ...
                    <TextInput
                      ...
                      onChangeText={(text) =>
                        handleInputChange2("message", text)
                      }
