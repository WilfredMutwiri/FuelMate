  ...
  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      doc
        ...
        .text("Email: info@fuelmate.co.ke | Phone: +254 745 567 568", {
          align: "center",
        })
      ...
      doc
        ...
        .font("Helvetica-Bold")
        .text(
          isEmergencyOrder(orderData)
            ? "EMERGENCY FUEL ORDER RECEIPT"
            : "ORDER RECEIPT",
          { align: "center" }
        );
        ...
        .text(
          `Phone Number: ${
            isEmergencyOrder(orderData)
              ...
              : orderData.clientPhoneNo || "N/A"
          }`
        )
        .text(
          `Delivery Location: ${
            isEmergencyOrder(orderData)
              ? orderData.readableLocation
      ...
      doc
        .font("Helvetica-Bold")
        .text(
          `Total Amount: KES ${amount.toLocaleString("en-KE")}`,
          50,
          rowY + 10,
          { align: "right" }
        );
