        ...
        <div className="flex-1 gap-4 mt-4">
          ...
          >
            <div className="flex justify-between bg-gray-200 rounded-md p-2">
              <h2 className="mx-auto p-2 text-left text-lg text-yellow-700">
                Pending Emergency Orders{" "}
                <span className="pl-10 text-yellow-700">
                  {" "}
                    ...
                    emergencyOrders?.map((order) => (
                      ...
                      >
                        ...
                        <Table.Cell className="text-black">
                          <Link
                            to={`/order/${order._id}`}
                            className="font-medium text-yellow-700 hover:text-red-600 hover:underline"
                          >
                            View
                          </Link>
                        </Table.Cell>
