            ...
            <div className="overflow-x-auto">
              <Table hoverable>
                ...
                <Table.Body className="divide-y">
                  {notApprovedStations.length > 0 &&
                    notApprovedStations.map((station) => (
                      <Table.Row
                        key={station._id}
                      ...
                      >
                        ...
                        <Table.Cell className="text-black">
                          <a
                            href={station?.BusinessCert}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="demographyLi cursor-pointer"
                          >
                            Reg_Certificate
                          </a>
                        </Table.Cell>
                        ...
                        <Table.Cell className="text-black">
                          <Link
                            ...
                            className="font-medium text-cyan-700 hover:text-red-600 hover:underline"
                          >
                            View
                          </Link>
                        </Table.Cell>
